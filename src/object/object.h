...
latte_object_t* latte_object_decr_ref_count(latte_object_t* o);
latte_object_t* latte_object_incr_ref_count(latte_object_t* o);
latte_object_t* make_object_shared(latte_object_t* o);

char* str_encoding(int encoding);
size_t object_string_compute_size(latte_object_t* o);
size_t object_compute_size(latte_object_t* o, size_t sample_size);
...
// void freeModuleObject(latte_object_t *o);
// void freeStreamObject(latte_object_t *o);
#endif