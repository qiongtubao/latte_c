...
#ifndef __LATTE_CONNECTION_H
#define __LATTE_CONNECTION_H
#include <stdint.h>
#include "sds.h"
#include "zmalloc.h"
#include "ae.h"
...
static  ssize_t connSyncReadLine(connection *conn, char *ptr, ssize_t size, long long timeout) {
    return conn->type->sync_readline(conn, ptr, size, timeout);
}

/* Return CONN_TYPE_* for the specified connection */
static  int connGetType(connection *conn) {
...
connection *connCreateTLS(aeEventLoop *el);
